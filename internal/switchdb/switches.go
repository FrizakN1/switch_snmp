...
var eltexMES2324OID = domain.SwitchOID{
	...
	PortDesc:                  "1.3.6.1.4.1.35265.1.23.1.1.31.1.1.1.1",
...
var Switches = map[string]domain.SwitchOID{
	...
	"DGS-1100-06/ME": {
		...
		CableDistance: "1.3.6.1.4.1.171.10.134.1.1.35",
	},
	"DGS-1100-10/ME": {
		...
		CableDistance: "1.3.6.1.4.1.171.10.134.2.1.35",
	},
	"DGS-1210-10/C1": {
	...
	"DGS-1210-28": {
		...
		SN:           "1.3.6.1.4.1.171.10.76.43.1.1.30.0",
	...
	"DGS-1210-28X/ME/B1": {
		Firmware:     "1.3.6.1.4.1.171.10.76.43.1.1.3.0",
		SystemName:   "1.3.6.1.4.1.171.10.76.43.1.1.1.0",
		SN:           "1.3.6.1.4.1.171.10.76.43.1.1.30.0",
		SaveConfig:   "1.3.6.1.4.1.171.10.76.43.1.1.10.0",
		PortDesc:     "1.3.6.1.4.1.171.10.76.43.1.1.14.1.3",
		PortAmount:   28,
		Vlan:         "1.3.6.1.4.1.171.10.76.43.1.7.6.1.3",
		VlanUntagged: "1.3.6.1.4.1.171.10.76.43.1.7.6.1.5",
		Speed:        "1.3.6.1.4.1.171.10.76.43.1.1.13.1.4",
		BandwidthTX:  "1.3.6.1.4.1.171.10.76.43.1.13.1.2.1.2",
		BandwidthRX:  "1.3.6.1.4.1.171.10.76.43.1.13.1.2.1.3",
	},
	...
	"MES2324FB":  eltexMES2324OID, //https://eltexcm.ru/assets/docs/site/MES_configuration_and_monitoring_via_SNMP_4_0_16_5.pdf
	"MES2300-24": eltexMES2324OID,
	"MES1124MB":  eltexMES2324OID,
	"MES2124MB":  eltexMES2324OID,
	...
	"Cisco": {
		...
		CPUUtilizationOneMinutes:  "1.3.6.1.4.1.9.2.1.57.0",
		CPUUtilizationFiveMinutes: "1.3.6.1.4.1.9.2.1.58.0",
		PortDesc:                  "1.3.6.1.2.1.31.1.1.1.18",
